    ...
    <div v-if="title" class="task-list-header">
      ...
      <a-space v-if="showFilters">
        ...
        >
          ...
          <a-select-option value="non_validé">Non validé</a-select-option>
          <a-select-option value="validé">Validé</a-select-option>
          <a-select-option value="en_cours">En cours</a-select-option>
...
const sortedTasks = computed(() => {
  ...
  switch (sortBy.value) {
    ...
    case 'status':
      const statusOrder = { 'non_validé': 1, 'validé': 2, 'en_cours': 3, 'completed': 4 }
